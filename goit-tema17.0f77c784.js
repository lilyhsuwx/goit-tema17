...
function getImagesApi() {
    return fetch(`${URL}?key=${API_KEY}&q=${search}&page=${currentPage}&per_page=${limit}&orientation=horizontal`).then((res)=>res.json());
}
function render() {
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire7b8d", {})

//# sourceMappingURL=goit-tema17.0f77c784.js.map
